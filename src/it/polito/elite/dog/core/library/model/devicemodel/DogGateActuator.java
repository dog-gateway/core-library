...
/**
* DogGateActuatorModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.GateActuator;
...
public class DogGateActuator extends AbstractDevice implements GateActuator
{

	public DogGateActuator(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((GateActuator) this.driver).getState();
		}
		 return null;
	}
	...
	public void close()
	{
		if(this.driver!=null)
		{
			((GateActuator) this.driver).close();
		}
	}
	...
	public void notifyOpen(String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(GateActuator.class.getSimpleName());
