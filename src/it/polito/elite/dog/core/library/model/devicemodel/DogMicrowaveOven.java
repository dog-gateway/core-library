...
public class DogMicrowaveOven extends AbstractDevice implements MicrowaveOven
{
	...
	public void notifyStandby(String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(MicrowaveOven.class.getSimpleName());
	...
	public void notifyOn()
{
	...
	public void notifyNotEmittingMicrowaves(String notificationId)
	{
...
{
		// call the more general method with a null notification id.
		this.notifyNotEmittingMicrowaves(null);
	}
	...
	public void notifyChangedStartTime(Measure<?,?>  startTime)
{
	...
	public void notifyEmittingMicrowaves(String notificationId)
	{
...
{
		// call the more general method with a null notification id.
		this.notifyEmittingMicrowaves(null);
	}
