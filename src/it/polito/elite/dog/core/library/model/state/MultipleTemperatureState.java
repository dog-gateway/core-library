...
/**
* MultipleTemperatureState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class MultipleTemperatureState extends ContinuousState
{
	/**
	 ...
	 */
	@Deprecated
	public MultipleTemperatureState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			MultipleTemperatureStateValue sValue = new MultipleTemperatureStateValue();
	 ...
	 * Default constructor.
	 */
	public MultipleTemperatureState()
	{
		super();
	}
}
