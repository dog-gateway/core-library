...
/**
* DogZigBeeGatewayModel - automatically generated by DogOnt2Dog
*/
...
public class DogZigBeeGateway extends AbstractDevice implements ZigBeeGateway
{
	...
	public DogZigBeeGateway(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void notifyOpen(String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(ZigBeeGateway.class.getSimpleName());
