...
/**
* HumidityMeasurementState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class HumidityMeasurementState extends ContinuousState
{
	/**
	 ...
	 */
	public HumidityMeasurementState(HumidityStateValue humiditystatevalue)
	{
		//call the super class constructor
		super(humiditystatevalue);
	}
	/**
	 ...
	 */
	@Deprecated
	public HumidityMeasurementState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			HumidityStateValue sValue = new HumidityStateValue();
	 ...
	 * Default constructor.
	 */
	public HumidityMeasurementState()
	{
		super();
	}
}
