...
/**
* DogHotplateModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.Hotplate;
...
public class DogHotplate extends AbstractDevice implements Hotplate
{

	public DogHotplate(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public Measure<?,?>  getStartTime()
	{
		if(this.driver!=null)
		{
			return ((Hotplate) this.driver).getStartTime();
		}
		 return null;
	}
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((Hotplate) this.driver).getState();
		}
		 return null;
	}
	...
	public Measure<?,?>  getRemainingTime()
	{
		if(this.driver!=null)
		{
			return ((Hotplate) this.driver).getRemainingTime();
		}
		 return null;
	}
	...
	public Measure<?,?>  getEndTime()
	{
		if(this.driver!=null)
		{
			return ((Hotplate) this.driver).getEndTime();
		}
		 return null;
	}
	...
	public Object[] getEventsAndAlerts()
	{
		if(this.driver!=null)
		{
			return ((Hotplate) this.driver).getEventsAndAlerts();
		}
		 return null;
	}
	...
	public void notifyNewEvent(Object event, Object sensorId, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(Hotplate.class.getSimpleName());
