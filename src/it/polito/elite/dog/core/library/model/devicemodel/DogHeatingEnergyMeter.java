...
public class DogHeatingEnergyMeter extends AbstractDevice implements HeatingEnergyMeter
{
	...
	public DogHeatingEnergyMeter(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void notifyNewHeatingEnergyValue(Measure<?,?>  heatingEnergy, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(HeatingEnergyMeter.class.getSimpleName());
	...
	public void notifyNewHeatingEnergyValue(Measure<?,?>  heatingEnergy)
{
		...
		this.notifyNewHeatingEnergyValue(heatingEnergy , null);
	}
	@Override
