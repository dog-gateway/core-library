...
/**
* FaultState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class FaultState extends DoubleValuedState
{
	/**
	...
	public static final String NOFAILURE = "noFailure";


	/**
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public FaultState(FailureStateValue failurestatevalue)
	{
	 ...
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public FaultState(NoFailureStateValue nofailurestatevalue)
	{
		//call the super class constructor
		super(new StateValue[]{nofailurestatevalue});
	}

	@Deprecated
	private void initCommon()
	{
		this.old2NewMap.put(FaultState.FAILURE, new FailureStateValue());
		this.old2NewMap.put(FaultState.NOFAILURE, new NoFailureStateValue());
	}
	/**
	 ...
	 */
	@Deprecated
	public FaultState(Object valueOfTheCurrentStateValue)
	{
		this.initCommon();
	 ...
	 * Class constructor.
	 */
	public FaultState(StateValue... currentStateValue)
	{
