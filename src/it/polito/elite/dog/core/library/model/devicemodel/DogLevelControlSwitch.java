...
/**
* DogLevelControlSwitchModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.LevelControlSwitch;
...
public class DogLevelControlSwitch extends AbstractDevice implements LevelControlSwitch
{

	public DogLevelControlSwitch(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((LevelControlSwitch) this.driver).getState();
		}
		 return null;
	}
	...
	public void notifyChangedLevel(Measure<?,?>  newLevel, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(LevelControlSwitch.class.getSimpleName());
