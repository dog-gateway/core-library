...
/**
* TridimensionalGyroscopeNotification - automatically generated by DogOnt2Dog
*/

import javax.measure.Measure;

public class TridimensionalGyroscopeNotification implements ParametricNotification
{
	public static String notificationName = "new3DGyroscopeValue";

	public static String notificationTopic="it/polito/elite/dog/core/library/model/notification/TridimensionalGyroscopeNotification";
	...
	*/
	...
	{
		 return TridimensionalGyroscopeNotification.notificationTopic; 
	}
	...
	*/
	...
	private Measure<?,?>  gyroZ;

	private Measure<?,?>  gyroX;

	private Measure<?,?>  gyroY;


	public TridimensionalGyroscopeNotification(Measure<?,?>  gyroZ, Measure<?,?>  gyroX, Measure<?,?>  gyroY)
	{
	...
	public Measure<?,?>  getGyroZ(){
		return this.gyroZ;
	}

	public Measure<?,?>  getGyroX(){
		return this.gyroX;
	}

	public Measure<?,?>  getGyroY(){
		return this.gyroY;
	}
	...
	*/
	...
	{
		Measure<?,?> [] value = new Measure<?,?> []{this.gyroX,this.gyroY,this.gyroZ};
