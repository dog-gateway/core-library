...
/**
* DogCC2650IRSensorModel - automatically generated by DogOnt2Dog
*/
...
public class DogCC2650IRSensor extends AbstractDevice implements CC2650IRSensor
{

	public DogCC2650IRSensor(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void deleteGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((CC2650IRSensor) this.driver).deleteGroup(groupID);
		}
	}
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((CC2650IRSensor) this.driver).getState();
		}
		 return null;
	}
	...
	public void storeGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((CC2650IRSensor) this.driver).storeGroup(groupID);
		}
	}
	...
	public Measure<?,?>  getTemperatureFrom(String sensorURI)
	{
		if(this.driver!=null)
		{
			return ((CC2650IRSensor) this.driver).getTemperatureFrom(sensorURI);
		}
		 return null;
	}
	...
	public void notifyLeftGroup(Integer groupNumber, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(CC2650IRSensor.class.getSimpleName());
