...
/**
* MultiplePressureState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class MultiplePressureState extends ContinuousState
{
	/**
	 ...
	 */
	@Deprecated
	public MultiplePressureState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			MultiplePressureStateValue sValue = new MultiplePressureStateValue();
