...
/**
* ThreePhaseCurrentState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class ThreePhaseCurrentState extends CurrentMeasurementState
{
	/**
	 ...
	 */
	public ThreePhaseCurrentState(CurrentStateValue currentstatevalue,CurrentStateValue currentstatevalue1,CurrentStateValue currentstatevalue2)
	{
		//call the super class constructor
		super(currentstatevalue,currentstatevalue1,currentstatevalue2);
	}
	/**
	 ...
	 */
	@Deprecated
	public ThreePhaseCurrentState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			CurrentStateValue sValue = new CurrentStateValue();
