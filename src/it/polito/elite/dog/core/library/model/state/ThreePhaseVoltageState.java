...
/**
* ThreePhaseVoltageState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class ThreePhaseVoltageState extends VoltageMeasurementState
{
	/**
	 ...
	 */
	public ThreePhaseVoltageState(VoltageStateValue voltagestatevalue,VoltageStateValue voltagestatevalue1,VoltageStateValue voltagestatevalue2)
	{
		//call the super class constructor
		super(voltagestatevalue,voltagestatevalue1,voltagestatevalue2);
	}
	/**
	 ...
	 */
	@Deprecated
	public ThreePhaseVoltageState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			VoltageStateValue sValue = new VoltageStateValue();
