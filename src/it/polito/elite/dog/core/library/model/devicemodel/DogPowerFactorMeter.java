...
/**
* DogPowerFactorMeterModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.PowerFactorMeter;
...
public class DogPowerFactorMeter extends AbstractDevice implements PowerFactorMeter
{

	public DogPowerFactorMeter(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((PowerFactorMeter) this.driver).getState();
		}
		 return null;
	}
	...
	public Measure<?,?>  getPowerFactor()
	{
		if(this.driver!=null)
		{
			return ((PowerFactorMeter) this.driver).getPowerFactor();
		}
		 return null;
	}
