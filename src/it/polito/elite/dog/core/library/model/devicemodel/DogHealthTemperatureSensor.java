...
/**
* DogHealthTemperatureSensorModel - automatically generated by DogOnt2Dog
*/
...
public class DogHealthTemperatureSensor extends AbstractDevice implements HealthTemperatureSensor
{

	public DogHealthTemperatureSensor(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void deleteGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((HealthTemperatureSensor) this.driver).deleteGroup(groupID);
		}
	}
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((HealthTemperatureSensor) this.driver).getState();
		}
		 return null;
	}
	...
	public Measure<?,?>  getTemperature()
	{
		if(this.driver!=null)
		{
			return ((HealthTemperatureSensor) this.driver).getTemperature();
		}
		 return null;
	}
	...
	public void storeGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((HealthTemperatureSensor) this.driver).storeGroup(groupID);
		}
	}
	...
	public void notifyLeftGroup(Integer groupNumber, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(HealthTemperatureSensor.class.getSimpleName());
