...
/**
* TeachInState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class TeachInState extends DoubleValuedState
{
	/**
	...
	public static final String TEACHINGIN = "teachingIn";
	 ...
	 */
	public TeachInState(TeachingInStateValue teachinginstatevalue)
	{
		//call the super class constructor
		super(new StateValue[]{teachinginstatevalue});
	}
	 ...
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public TeachInState(IdleStateValue idlestatevalue)
	{
		//call the super class constructor
	...
	{
		this.old2NewMap.put(TeachInState.TEACHINGIN, new TeachingInStateValue());
		this.old2NewMap.put(TeachInState.IDLE, new IdleStateValue());
	}
	/**
	 ...
	 */
	@Deprecated
	public TeachInState(Object valueOfTheCurrentStateValue)
	{
		this.initCommon();
	 ...
	 * Class constructor.
	 */
	public TeachInState(StateValue... currentStateValue)
	{
