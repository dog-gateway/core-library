...
/**
* MultipleFlowRateState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class MultipleFlowRateState extends ContinuousState
{
	/**
	 ...
	 */
	public MultipleFlowRateState(MultipleFlowRateStateValue multipleflowratestatevalue)
	{
		//call the super class constructor
		super(multipleflowratestatevalue);
	}
	/**
	 ...
	 */
	@Deprecated
	public MultipleFlowRateState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			MultipleFlowRateStateValue sValue = new MultipleFlowRateStateValue();
