...
public class DogElectricalOven extends AbstractDevice implements ElectricalOven
{
	...
	public DogElectricalOven(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void notifyNewEvent(Object event, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(ElectricalOven.class.getSimpleName());
