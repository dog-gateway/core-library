...
/**
* DogSmartWasteBinModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.SmartWasteBin;
...
public class DogSmartWasteBin extends AbstractDevice implements SmartWasteBin
{

	public DogSmartWasteBin(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void deleteGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((SmartWasteBin) this.driver).deleteGroup(groupID);
		}
	}
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((SmartWasteBin) this.driver).getState();
		}
		 return null;
	}
	...
	public Measure<?,?>  getFillLevel()
	{
		if(this.driver!=null)
		{
			return ((SmartWasteBin) this.driver).getFillLevel();
		}
		 return null;
	}
	...
	public Measure<?,?>  getTemperature()
	{
		if(this.driver!=null)
		{
			return ((SmartWasteBin) this.driver).getTemperature();
		}
		 return null;
	}
	...
	public void storeGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((SmartWasteBin) this.driver).storeGroup(groupID);
		}
	}
	...
	public void notifyChangedLevel(Measure<?,?>  newLevel, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(SmartWasteBin.class.getSimpleName());
