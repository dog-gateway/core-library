...
/**
* OpenCloseState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class OpenCloseState extends DoubleValuedState
{
	/**
	 ...
	 */
	public OpenCloseState(CloseStateValue closestatevalue)
	{
	 ...
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public OpenCloseState(OpenStateValue openstatevalue)
	{
		//call the super class constructor
	...
	{
		this.old2NewMap.put(OpenCloseState.CLOSE, new CloseStateValue());
		this.old2NewMap.put(OpenCloseState.OPEN, new OpenStateValue());
	}
	/**
	 ...
	 */
	@Deprecated
	public OpenCloseState(Object valueOfTheCurrentStateValue)
	{
		this.initCommon();
	 ...
	 * Class constructor.
	 */
	public OpenCloseState(StateValue... currentStateValue)
	{
