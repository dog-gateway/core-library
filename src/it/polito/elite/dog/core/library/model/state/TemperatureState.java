...
/**
* TemperatureState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class TemperatureState extends ContinuousState
{
	/**
	 ...
	 */
	public TemperatureState(TemperatureStateValue temperaturestatevalue)
	{
		//call the super class constructor
		super(temperaturestatevalue);
	}
	/**
	 ...
	 */
	@Deprecated
	public TemperatureState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			TemperatureStateValue sValue = new TemperatureStateValue();
	 ...
	 * Class constructor.
	 */
	public TemperatureState(StateValue... currentStateValue)
	{
