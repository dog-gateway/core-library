...
/**
* DogElectricalCookerModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.ElectricalCooker;
...
public class DogElectricalCooker extends AbstractDevice implements ElectricalCooker
{

	public DogElectricalCooker(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((ElectricalCooker) this.driver).getState();
		}
		 return null;
	}
	...
	public void on()
	{
		if(this.driver!=null)
		{
			((ElectricalCooker) this.driver).on();
		}
	}
	...
	public void setStartTime(Measure<?,?>  endTime, Measure<?,?>  remainingTime, Measure<?,?>  startTime)
	{
		if(this.driver!=null)
		{
			((ElectricalCooker) this.driver).setStartTime(endTime, remainingTime, startTime);
		}
	}
	...
	public void notifyNewEventSet(Object[] events, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(ElectricalCooker.class.getSimpleName());
