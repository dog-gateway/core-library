...
/**
* DogDishwasherModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.Dishwasher;
...
public class DogDishwasher extends AbstractDevice implements Dishwasher
{

	public DogDishwasher(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public Measure<?,?>  getRemainingTime()
	{
		if(this.driver!=null)
		{
			return ((Dishwasher) this.driver).getRemainingTime();
		}
		 return null;
	}
