...
/**
* OccupancyState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class OccupancyState extends DoubleValuedState
{
	/**
	 ...
	 */
	public OccupancyState(OccupiedStateValue occupiedstatevalue)
	{
		//call the super class constructor
		super(new StateValue[]{occupiedstatevalue});
	}
	 ...
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public OccupancyState(FreeStateValue freestatevalue)
	{
		//call the super class constructor
		super(new StateValue[]{freestatevalue});
	}

	@Deprecated
	private void initCommon()
	{
		this.old2NewMap.put(OccupancyState.PERSONINSIDE, new OccupiedStateValue());
		this.old2NewMap.put(OccupancyState.NOPERSONINSIDE, new FreeStateValue());
	}
	/**
	 ...
	 */
	@Deprecated
	public OccupancyState(Object valueOfTheCurrentStateValue)
	{
		this.initCommon();
	 ...
	 * Class constructor.
	 */
	public OccupancyState(StateValue... currentStateValue)
	{
