...
/**
* DogTemperatureAndHumiditySensorModel - automatically generated by DogOnt2Dog
*/
...
public class DogTemperatureAndHumiditySensor extends AbstractDevice implements TemperatureAndHumiditySensor
{

	public DogTemperatureAndHumiditySensor(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public Measure<?,?>  getRelativeHumidity()
	{
		if(this.driver!=null)
		{
			return ((TemperatureAndHumiditySensor) this.driver).getRelativeHumidity();
		}
		 return null;
	}
	...
	public Measure<?,?>  getTemperature()
	{
		if(this.driver!=null)
		{
			return ((TemperatureAndHumiditySensor) this.driver).getTemperature();
		}
		 return null;
	}
	...
	public void storeGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((TemperatureAndHumiditySensor) this.driver).storeGroup(groupID);
		}
	}
	...
	public void notifyLeftGroup(Integer groupNumber, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(TemperatureAndHumiditySensor.class.getSimpleName());
