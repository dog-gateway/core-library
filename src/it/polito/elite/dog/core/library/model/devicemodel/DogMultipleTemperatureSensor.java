...
/**
* DogMultipleTemperatureSensorModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.MultipleTemperatureSensor;
...
public class DogMultipleTemperatureSensor extends AbstractDevice implements MultipleTemperatureSensor
{

	public DogMultipleTemperatureSensor(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((MultipleTemperatureSensor) this.driver).getState();
		}
		 return null;
	}
	...
	public void storeGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((MultipleTemperatureSensor) this.driver).storeGroup(groupID);
		}
	}
	...
	public void notifyLeftGroup(Integer groupNumber, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(MultipleTemperatureSensor.class.getSimpleName());
