...
/**
* HeaterState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class HeaterState extends TripleValuedState
{
	/**
	...
	public static final String FIRINGUP = "firingUp";
	 ...
	 */
	public HeaterState(FireUpStateValue fireupstatevalue)
	{
		//call the super class constructor
		super(new StateValue[]{fireupstatevalue});
	}
	 ...
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public HeaterState(HeatingStateValue heatingstatevalue)
	{
		//call the super class constructor
	 ...
	 * Class constructor for states inheriting from DiscreteState.
	 */
	public HeaterState(CoolingStateValue coolingstatevalue)
	{
		//call the super class constructor
	...
	{
		this.old2NewMap.put(HeaterState.FIRINGUP, new FireUpStateValue());
		this.old2NewMap.put(HeaterState.HEATING, new HeatingStateValue());
		this.old2NewMap.put(HeaterState.COOLING, new CoolingStateValue());
	}
	/**
	 ...
	 */
	@Deprecated
	public HeaterState(Object valueOfTheCurrentStateValue)
	{
		this.initCommon();
	 ...
	 * Class constructor.
	 */
	public HeaterState(StateValue... currentStateValue)
	{
