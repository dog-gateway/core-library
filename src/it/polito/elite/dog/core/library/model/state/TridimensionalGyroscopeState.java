...
/**
* TridimensionalGyroscopeState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class TridimensionalGyroscopeState extends ContinuousState
{
	/**
	 ...
	 */
	public TridimensionalGyroscopeState(GyroscopeStateValue gyroscopestatevalue,GyroscopeStateValue gyroscopestatevalue1,GyroscopeStateValue gyroscopestatevalue2)
	{
		//call the super class constructor
		super(gyroscopestatevalue,gyroscopestatevalue1,gyroscopestatevalue2);
	}
	/**
	 ...
	 */
	@Deprecated
	public TridimensionalGyroscopeState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			GyroscopeStateValue sValue = new GyroscopeStateValue();
	 ...
	 * Default constructor.
	 */
	public TridimensionalGyroscopeState()
	{
		super();
	}
}
