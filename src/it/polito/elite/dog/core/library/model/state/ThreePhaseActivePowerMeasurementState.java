...
/**
* ThreePhaseActivePowerMeasurementState - automatically generated by it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
* @author it.polito.elite.domotics.ontologies.dogont.utilities.DogOnt2Dog
*
*/
public class ThreePhaseActivePowerMeasurementState extends ActivePowerMeasurementState
{
	/**
	 ...
	 */
	public ThreePhaseActivePowerMeasurementState(ActivePowerStateValue activepowerstatevalue,ActivePowerStateValue activepowerstatevalue1,ActivePowerStateValue activepowerstatevalue2, PowerStateValue powerstatevalue)
	{
		//call the super class constructor
		super(activepowerstatevalue,activepowerstatevalue1,activepowerstatevalue2, powerstatevalue);
	}
	/**
	 ...
	 */
	@Deprecated
	public ThreePhaseActivePowerMeasurementState(Object valueOfTheCurrentStateValue)
	{
		this.valueOfTheCurrentStateValue = valueOfTheCurrentStateValue;

		if(!(valueOfTheCurrentStateValue instanceof String))
		{
			ActivePowerStateValue sValue1 = new ActivePowerStateValue();
	 ...
	 * Class constructor.
	 */
	public ThreePhaseActivePowerMeasurementState(StateValue... currentStateValue)
	{
	 ...
	 * Default constructor.
	 */
	public ThreePhaseActivePowerMeasurementState()
	{
		super();
	}
}
