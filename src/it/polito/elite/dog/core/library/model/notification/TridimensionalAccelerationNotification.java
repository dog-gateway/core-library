...
public class TridimensionalAccelerationNotification implements ParametricNotification
{
	...
	*/
	...
	private Measure<?,?>  accY;

	private Measure<?,?>  accZ;

	private Measure<?,?>  accX;


	public TridimensionalAccelerationNotification(Measure<?,?>  accY, Measure<?,?>  accZ, Measure<?,?>  accX)
	{
	...
	public Measure<?,?>  getAccY(){
		return this.accY;
	}

	public Measure<?,?>  getAccZ(){
		return this.accZ;
	}

	public Measure<?,?>  getAccX(){
		return this.accX;
	}
	...
	*/
	...
	{
		Measure<?,?> [] value = new Measure<?,?> []{this.accZ,this.accY,this.accX};
