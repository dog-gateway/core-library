...
/**
* DogColorDimmerSwitchModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.devicecategory.ColorDimmerSwitch;
...
public class DogColorDimmerSwitch extends AbstractDevice implements ColorDimmerSwitch
{

	public DogColorDimmerSwitch(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((ColorDimmerSwitch) this.driver).getState();
		}
		 return null;
	}
	...
	public void notifyChangedLevel(Measure<?,?>  newLevel, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(ColorDimmerSwitch.class.getSimpleName());
