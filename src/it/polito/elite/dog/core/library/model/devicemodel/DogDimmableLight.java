...
/**
* DogDimmableLightModel - automatically generated by DogOnt2Dog
*/
...
public class DogDimmableLight extends AbstractDevice implements DimmableLight
{

	public DogDimmableLight(BundleContext context, DeviceDescriptor deviceDescriptor)
	{
		super(context);
	...
	public void deleteGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).deleteGroup(groupID);
		}
	}
	...
	public void stepUp()
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).stepUp();
		}
	}
	...
	public DeviceStatus getState()
	{
		if(this.driver!=null)
		{
			return ((DimmableLight) this.driver).getState();
		}
		 return null;
	}
	...
	public void set(Object value)
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).set(value);
		}
	}
	...
	public void storeGroup(Integer groupID)
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).storeGroup(groupID);
		}
	}
	...
	public void deleteScene(Integer sceneNumber)
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).deleteScene(sceneNumber);
		}
	}
	...
	public void stepDown()
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).stepDown();
		}
	}
	...
	public void storeScene(Integer sceneNumber)
	{
		if(this.driver!=null)
		{
			((DimmableLight) this.driver).storeScene(sceneNumber);
		}
	}
	...
	public void notifyChangedLevel(Measure<?,?>  newLevel, String notificationId)
	{
		...
		notificationEvent.setDeviceClassName(DimmableLight.class.getSimpleName());
